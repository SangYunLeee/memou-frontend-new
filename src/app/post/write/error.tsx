    ...
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white rounded-lg border border-red-200 p-6">
        ...
        <p className="text-sm text-gray-600 text-center mb-4">
          글 작성 에디터를 불러오는 중 문제가 발생했습니다.
        </p>
        {process.env.NODE_ENV === 'development' && (
          <div className="mb-4 p-3 bg-gray-100 rounded text-xs text-gray-700 overflow-auto max-h-24">
        ...
        <div className="flex gap-2">
          <button
            onClick={reset}
            className="flex-1 px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition-colors text-sm"
          >
            다시 시도
          </button>
          <button
